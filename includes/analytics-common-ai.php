...
function processAnalyticsData($queryResult) {
    ...
    // No AI calls here to keep page load fast
    $statistics = [];
    ...
    foreach ($results as $row) {
        ...
        if ($row['question_type'] === 'drop_down' || $row['question_type'] === 'checkbox') {
            ...
            // Process checkbox or drop_down answers
        ...
        // We do NOT call AI here; that is delayed until user requests it
