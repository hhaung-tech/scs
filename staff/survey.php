...
// Validate that staff survey is active
validateSurveyAccess($pdo, 'staff');
...
if (!isset($_SESSION['survey_code'])) {
    if (isset($_POST['survey_code'])) {
        ...
        if ($stmt->rowCount() > 0) {
            ...
            $_SESSION['authenticated_staff'] = true;
...
if (!isset($_SESSION['authenticated_staff']) || !$_SESSION['authenticated_staff']) {
...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['answers'])) {
    try {
        ...
        unset($_SESSION['authenticated_staff']);
...
$results = getSurveyQuestions($pdo, 'staff');
...
<?php include '../includes/header.php';?>
    ...
    <div class="survey-header">
        <h1>School Climate Survey - Board</h1>
...
<script src="/../assets/scripts/scs/survey.js"></script>
