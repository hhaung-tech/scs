...
// Validate that alumni survey is active
validateSurveyAccess($pdo, 'alumni');
...
if (!isset($_SESSION['survey_code'])) {
    if (isset($_POST['survey_code'])) {
        ...
        if ($stmt->rowCount() > 0) {
            ...
            $_SESSION['authenticated_alumni'] = true;
...
if (!isset($_SESSION['authenticated_alumni']) || !$_SESSION['authenticated_alumni']) {
...
$results = getSurveyQuestions($pdo, 'alumni');
...
<?php include '../includes/header.php';?>
    ...
    <div class="survey-header">
        <h1>School Climate Survey - alumni</h1>
